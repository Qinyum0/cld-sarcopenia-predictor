...
def main():
    ...
    if st.sidebar.button('Predict'):
        patient_data = {
            ...
            'drink': 1 if drink == 'Yes' else 0,
            'hypertension': 1 if hypertension == 'Yes' else 0,
            'dyslipidemia': 1 if dyslipidemia == 'Yes' else 0,
            'diabetes': 1 if diabetes == 'Yes' else 0,
            'kidney': 1 if kidney == 'Yes' else 0,
            'stomach': 1 if stomach == 'Yes' else 0,
            'psychiatric': 1 if psychiatric == 'Yes' else 0,
        ...
        if prediction is not None:
            ...
            st.progress(proba[1])
            st.write(f'Non-Sarcopenia: {proba[0]*100:.2f}% | Sarcopenia: {proba[1]*100:.2f}%')
